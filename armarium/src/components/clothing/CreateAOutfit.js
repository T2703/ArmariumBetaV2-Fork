...
function Outfit() {
  ...
  const [showLayers, setShowLayers] = useState(false); // State for toggling top layers/accessories visibility
  const DELAY = 650;
      ...
      <div>
        ...
        <div className="App" id="homepage">
          ...
          <div className="header-buttons">
            ...
            <button onClick={toggleLayers} className="flip-btn">
              Flip
            </button>
          </div>
                      ...
                      <div className="overlay-container">
                        ...
                        <div className="overlay-items">
                          {selectedTopLayers.length > 0 ? (
                            selectedTopLayers.map((url, index) => (
                              <img key={index} src={url} alt={`Top Layer ${index + 1}`} className="overlay-image" />
                            ))
                          ) : (
                      ...
                      <div className="overlay-container">
                        ...
                        <div className="overlay-items">
                          {selectedAccessories.length > 0 ? (
                            selectedAccessories.map((url, index) => (
                              <img key={index} src={url} alt={`Accessory ${index + 1}`} className="overlay-image" />
                            ))
                          ) : (
